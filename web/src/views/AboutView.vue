...
<template>
  <div class="container max-w-4xl py-10 space-y-8">
    <div class="space-y-2 text-center md:text-left">
      <h1 class="text-4xl font-extrabold tracking-tight">关于本项目</h1>
    ...
    <div class="grid gap-6 md:grid-cols-2">
        <Card class="bg-background/50 backdrop-blur-sm border-white/10 md:col-span-2">
          ...
          <CardContent class="space-y-4 text-muted-foreground leading-relaxed">
            <p>
                 ...
                 <div class="flex items-start gap-4">
                     <div class="space-y-1">
                         ...
                         <div class="flex items-center gap-2 text-xs text-muted-foreground mt-1">
                             ...
                             <span class="border-l pl-2">QQ: 3436464181</span>
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="flex items-start gap-4">
                     <div class="space-y-1">
                         ...
                         <div class="flex items-center gap-2 text-xs text-muted-foreground mt-1">
                             ...
                             <span class="border-l pl-2">QQ: 417158478</span>
                         </div>
                     </div>
                 </div>
                 <div class="space-y-1 pt-2 border-t border-dashed border-white/10">
    ...
    <div class="grid gap-6 md:grid-cols-2">
        ...
        <Card class="bg-background/50 backdrop-blur-sm border-white/10 flex flex-col justify-center items-center text-center p-6">
             <Github class="h-10 w-10 mb-4 text-foreground/80" />
             <h3 class="font-semibold mb-2">开源贡献</h3>
             <p class="text-sm text-muted-foreground mb-4">
                 本项目代码完全开源。欢迎 Star、Fork 或提交 Pull Request。
             </p>
             <Button as="a" href="https://github.com/leemwood/lemwood_mirror/" target="_blank">
                 前往 GitHub 仓库
             </Button>
        </Card>
    </div>
